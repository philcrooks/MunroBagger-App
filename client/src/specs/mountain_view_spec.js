...
describe("MountainView", function(){
  ...
  it ( 'Is not hidden', function() {
	  assert.strictEqual(mountainView.hidden, false);
  });
  ...
  describe( 'saveStatus', function() {
  	...
  	before (function() {
			fn = sinon.stub();
			fn.returns(stub_return);
  	});

  	it ( 'Returns null if saveStatus is null', function() {
  		assert.strictEqual(mountainView.save(), null);
  	});
