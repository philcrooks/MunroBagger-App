...
describe("API Request", function() {
  ...
  describe("All Request Types", function() {
    ...
    it("Create a POST Request", function () {
      ...
      apiRequest.makePostRequest(url, params, null, true, function(){});
    ...
    it("Create a PUT Request", function () {
      ...
      apiRequest.makePutRequest(url, params, token, true, function(){});
    ...
    it("Create a DELETE Request", function () {
      ...
      apiRequest.makeDeleteRequest(url, null, token, true, function(){});
